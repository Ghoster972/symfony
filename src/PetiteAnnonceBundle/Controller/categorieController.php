...
use PetiteAnnonceBundle\Entity\categorie;
use PetiteAnnonceBundle\Form\categorieType;
...
class categorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('PetiteAnnonceBundle:categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PetiteAnnonceBundle\Form\categorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('PetiteAnnonceBundle\Form\categorieType', $categorie);
